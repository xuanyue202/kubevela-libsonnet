{
  ...
  '#':: d.pkg(name='workloadDefinition', url='', help='"A WorkloadDefinition registers a kind of Kubernetes custom resource as a valid OAM workload kind by referencing its CustomResourceDefinition. The CRD is used to validate the schema of the workload when it is embedded in an OAM Component."'),
  ...
  '#new':: d.fn(help='new returns an instance of WorkloadDefinition', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'core.oam.dev/v1alpha2',
    kind: 'WorkloadDefinition',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"A WorkloadDefinitionSpec defines the desired state of a WorkloadDefinition."'),
  spec: {
    ...
    '#definitionRef':: d.obj(help='"Reference to the CustomResourceDefinition that defines this workload kind."'),
    definitionRef: {
