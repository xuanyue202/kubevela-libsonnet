{
  ...
  '#':: d.pkg(name='manualScalerTrait', url='', help='"A ManualScalerTrait determines how many replicas a workload should have."'),
  ...
  '#new':: d.fn(help='new returns an instance of ManualScalerTrait', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'core.oam.dev/v1alpha2',
    kind: 'ManualScalerTrait',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"A ManualScalerTraitSpec defines the desired state of a ManualScalerTrait."'),
  spec: {
    '#withReplicaCount':: d.fn(help='"ReplicaCount of the workload this trait applies to."', args=[d.arg(name='replicaCount', type=d.T.integer)]),
    withReplicaCount(replicaCount): { spec+: { replicaCount: replicaCount } },
    '#workloadRef':: d.obj(help='"WorkloadReference to the workload this trait applies to."'),
    workloadRef: {
      ...
      withFieldPath(fieldPath): { spec+: { workloadRef+: { fieldPath: fieldPath } } },
      ...
      withNamespace(namespace): { spec+: { workloadRef+: { namespace: namespace } } },
      ...
      withResourceVersion(resourceVersion): { spec+: { workloadRef+: { resourceVersion: resourceVersion } } },
      ...
      withUid(uid): { spec+: { workloadRef+: { uid: uid } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
