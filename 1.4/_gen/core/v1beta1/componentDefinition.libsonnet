{
  ...
  '#':: d.pkg(name='componentDefinition', url='', help='"ComponentDefinition is the Schema for the componentdefinitions API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ComponentDefinition', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    withChildResourceKindsMixin(childResourceKinds): { spec+: { childResourceKinds+: if std.isArray(v=childResourceKinds) then childResourceKinds else [childResourceKinds] } },
    ...
    withPodSpecPath(podSpecPath): { spec+: { podSpecPath: podSpecPath } },
    ...
    withRevisionLabel(revisionLabel): { spec+: { revisionLabel: revisionLabel } },
    ...
    workload: {
      ...
      definition: {
        ...
        withApiVersion(apiVersion): { spec+: { workload+: { definition+: { apiVersion: apiVersion } } } },
        '#withKind':: d.fn(help='', args=[d.arg(name='kind', type=d.T.string)]),
        withKind(kind): { spec+: { workload+: { definition+: { kind: kind } } } },
      },
      '#withType':: d.fn(help='"Type ref to a WorkloadDefinition via name"', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { workload+: { type: type } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
