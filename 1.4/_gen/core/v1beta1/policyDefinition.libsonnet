{
  ...
  '#':: d.pkg(name='policyDefinition', url='', help='"PolicyDefinition is the Schema for the policydefinitions API"'),
  ...
  '#new':: d.fn(help='new returns an instance of PolicyDefinition', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    withManageHealthCheck(manageHealthCheck): { spec+: { manageHealthCheck: manageHealthCheck } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
