{
  ...
  '#':: d.pkg(name='resourceTracker', url='', help='"An ResourceTracker represents a tracker for track cross namespace resources"'),
  ...
  '#new':: d.fn(help='new returns an instance of ResourceTracker', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    managedResources: {
      ...
      '#withCreator':: d.fn(help='"ResourceCreatorRole defines the resource creator."', args=[d.arg(name='creator', type=d.T.string)]),
      withCreator(creator): { creator: creator },
      '#withDeleted':: d.fn(help='"Deleted marks the resource to be deleted"', args=[d.arg(name='deleted', type=d.T.boolean)]),
      withDeleted(deleted): { deleted: deleted },
      ...
      '#withTrait':: d.fn(help='', args=[d.arg(name='trait', type=d.T.string)]),
      withTrait(trait): { trait: trait },
    ...
    '#withApplicationGeneration':: d.fn(help='', args=[d.arg(name='applicationGeneration', type=d.T.integer)]),
    withApplicationGeneration(applicationGeneration): { spec+: { applicationGeneration: applicationGeneration } },
    '#withManagedResources':: d.fn(help='', args=[d.arg(name='managedResources', type=d.T.array)]),
    withManagedResources(managedResources): { spec+: { managedResources: if std.isArray(v=managedResources) then managedResources else [managedResources] } },
    '#withManagedResourcesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='managedResources', type=d.T.array)]),
    withManagedResourcesMixin(managedResources): { spec+: { managedResources+: if std.isArray(v=managedResources) then managedResources else [managedResources] } },
    '#withType':: d.fn(help='"ResourceTrackerType defines the type of resourceTracker"', args=[d.arg(name='type', type=d.T.string)]),
