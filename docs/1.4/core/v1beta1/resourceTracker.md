---
permalink: /1.4/core/v1beta1/resourceTracker/
---

# core.v1beta1.resourceTracker
...
* [`obj spec`](#obj-spec)
  * [`fn withApplicationGeneration(applicationGeneration)`](#fn-specwithapplicationgeneration)
...
new returns an instance of ResourceTracker
...
### fn spec.withApplicationGeneration

```ts
withApplicationGeneration(applicationGeneration)
```
