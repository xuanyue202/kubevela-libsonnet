---
permalink: /1.4/core/v1alpha2/scopeDefinition/
---

# core.v1alpha2.scopeDefinition
...
* [`obj spec`](#obj-spec)
  * [`fn withAllowComponentOverlap(allowComponentOverlap)`](#fn-specwithallowcomponentoverlap)
  * [`fn withExtension(extension)`](#fn-specwithextension)
  * [`fn withExtensionMixin(extension)`](#fn-specwithextensionmixin)
  * [`fn withWorkloadRefsPath(workloadRefsPath)`](#fn-specwithworkloadrefspath)
...
new returns an instance of ScopeDefinition
...
### fn spec.withAllowComponentOverlap

```ts
withAllowComponentOverlap(allowComponentOverlap)
```
...
### fn spec.withWorkloadRefsPath

```ts
withWorkloadRefsPath(workloadRefsPath)
```
